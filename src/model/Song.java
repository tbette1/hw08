...
public interface Song {
     ...
     */
    void addNote(NoteImpl n, List<Attribute> actions, int startBeat);
     ...
     *              remain a rest.
     */
    void delete(NoteImpl n, ArrayList<Integer> beats);
     ...
     */
    ArrayList<NoteImpl> getNotes();

    /**
     * @return an ArrayList of all notes in the range of this song.
     */
    ArrayList<NoteImpl> getAllNotesInRange();
